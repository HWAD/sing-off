...
//       this.model.getMediaRecorder().setAudioSource(MediaRecorder.AudioSource.MIC);//androidAudioSource);
//       this.model.getMediaRecorder().setOutputFormat(MediaRecorder.OutputFormat.MPEG_4);//androidOutputFormat);
